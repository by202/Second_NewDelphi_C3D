...
parser.add_argument('--model_name', default='C3D', help='model to train')
parser.add_argument('--wd', type=float, default=0.0001, help='weight decay')
parser.add_argument('--batch_size', type=int, default=25, help='input batch size for training (default: 64)')
...
'''
checkpoint = torch.load('/content/drive/MyDrive/C3D/c3d.pickle')
...
video = '/content/drive/MyDrive/C3D/12.avi'
