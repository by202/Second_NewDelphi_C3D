...
# -*- coding: utf-8 -*-
"""
Created on Fri May 21 15:30:03 2021
...
def serialize_weights(model):
    ...
    np.save(os.path.join(f"model_new2.npy"), network_weights.astype(np.float64))
...
# =============================================================================
    ...
    # try:
    #     model.load_weights('/Users/bingyuliu/Desktop/c3d-pretrained.pth')
