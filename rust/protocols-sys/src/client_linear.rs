use crate::{
    client_linear::SEALClientLinear::{Conv3d, FullyConnected},
    *,
};
        ...
        match self {
            Conv3d {
                ...
                for chan in 0..data.out_chans as usize {
                        for dep in 0..data.output_d as usize{
                            for row in 0..data.output_h as usize {
                                for col in 0..data.output_w as usize {
                                    ...
                                    client_share_next[[0, chan, dep, row, col]] =
